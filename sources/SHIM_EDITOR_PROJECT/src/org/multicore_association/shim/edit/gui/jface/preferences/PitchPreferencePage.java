 ...
 */
public class PitchPreferencePage extends PreferencePage {
	...
	public Control createContents(Composite parent) {
		...
		textBest.addModifyListener(new TextRequiredModifier(pool, Pitch.class,
				"best"));
		...
		textTypical.addModifyListener(new UnsignedFloatModifier(pool, lblTypical
				.getText(), false));
		textWorst.addModifyListener(new TextRequiredModifier(pool, Pitch.class,
				"worst"));
