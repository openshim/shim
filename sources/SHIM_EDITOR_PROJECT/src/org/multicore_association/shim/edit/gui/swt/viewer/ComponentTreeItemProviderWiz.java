...
/**
 * A ComponentTreeItemProviderWiz for use with a ShimComponentTreeViewer on a
 * wizard page, which uses the ComponentSet to obtain the elements of a tree.
 */
public class ComponentTreeItemProviderWiz implements ITreeContentProvider {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof MasterComponent) {
			...
			if (accessTypeSet != null) {
				children.add(accessTypeSet);
			}
			
			CommonInstructionSet commonInstructionSet = mc.getCommonInstructionSet();
	...
	public Object[] getElements(Object inputElement) {
		...
		if (inputElement instanceof List) {
			...
			children.add(pf.getLatency());
			children.add(pf.getPitch());
			children.add(pf.getAccessTypeRef());
		}
